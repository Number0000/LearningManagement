...
import com.LibraryManagement.app.ControllerHelper.JsonConverter;
import com.LibraryManagement.app.Entity.BookCopies;
import com.LibraryManagement.app.ServiceHelper.BookCopiesService;
...
public class BookCopiesController {
	...
	// @RequestMapping(path="/lms/bookCopies/list/{bookId}/{branchId}",
	// method=RequestMethod.GET)
	// public String getBookCopiesById(@PathVariable(value = "bookId") int bookId,
	// @PathVariable(value = "branchId") int branchId){
	// List<BookCopies> bookCopies = new
	// BookCopiesService().getBookCopiesById(bookId, branchId);
	// JsonConverter converter = new JsonConverter();
	// String output = converter.convertToJson(bookCopies);
	// return output;
	// }
	...
	public BookCopies getBookCopiesByIdReturn(@PathVariable(value = "bookId") int bookId,
			@PathVariable(value = "branchId") int branchId) {
